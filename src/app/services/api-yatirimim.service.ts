...
export class OrderApiService {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<OrderModel>;
                }
            } else
                return _observableThrow(response_) as any as Observable<OrderModel>;
        }));
    }
    ...
    protected processAdd(response: HttpResponseBase): Observable<OrderModel> {
        ...
        return _observableOf<OrderModel>(null as any);
    }
